...
export default function Programmers() {
  ...
  const [listProgrammers, setListProgrammers] = useState(listOfAwesome)
  ...
  const getNameOfFeatured = () => {
    ...
    return listProgrammers[selectedProgrammer - 1].name
  };
  ...
  const style = {
    ...
    marginTop: '0.5em',
    color: //'royalblue',
    (selectedProgrammer ? 'gold' : 'royalblue') // 🤔 color turns to gold, when celebrating
  };
